...
export default function ChatPage() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    // Notify — only for global channel to avoid spam; dept channels notify dept members
    await notifyAll({
      title: `💬 ${activeChannel === "Global" ? "Global" : "#" + activeChannel}`,
      body: `${user.full_name}: ${newMessage.slice(0, 80)}`,
      url: "/dashboard/chats",
